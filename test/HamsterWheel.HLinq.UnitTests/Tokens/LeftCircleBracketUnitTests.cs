...
public class LeftCircleBracketUnitTests
{
    [Fact]
    public void Ctor_WhenCalled_ThenCreatesInstance()
    {
        //arrange
        //act
        var actual = new LeftCircleBracket();
    ...
    public void Empty_WhenCalled_ReturnsTheSameInstance()
    {
        //arrange
        //act
        var actual = LeftCircleBracket.Empty;

        //assert
        actual.Should().BeSameAs(LeftCircleBracket.Empty);
    }
    ...
    public void Build_WhenCalled_ReturnsInstanceWithRange()
    {
        ...
        //act
        var actual = LeftCircleBracket.Build(new(new(expected.Start.Value), new(expected.End.Value)));

        //assert
        var range = actual.Should().BeOfType<LeftCircleBracket>().Which.Range;
