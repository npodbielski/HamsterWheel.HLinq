...
public sealed class HLinqQueryQueryApplierNullException()
    : HLinqQueryException(
        $"{nameof(IHLinqQuery)} instance does not have {nameof(IHLinqQueryApplier)} assigned to it. If you created this instance manually, use {nameof(IHLinqQueryApplier)}.{nameof(IHLinqQueryApplier.Apply)} method instead.");