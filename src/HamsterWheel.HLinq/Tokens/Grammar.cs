...
public class Grammar(IServiceProvider serviceProvider) : IGrammar
{
    ...
    [
        ...
        new GrammarRule<Equality>(false, [typeof(NameOrValue), typeof(PropertyAccess), typeof(Entity)]),
        new GrammarRule<Inequality>(false, [typeof(NameOrValue), typeof(PropertyAccess), typeof(Entity)]),
        new GrammarRule<LessOrEqualThan>(false, [typeof(NameOrValue), typeof(PropertyAccess), typeof(Entity)]),
        new GrammarRule<LessThan>(false, [typeof(NameOrValue), typeof(PropertyAccess), typeof(Entity)], nextCharMatcher: c => c != EqualityTokenKeyword[0]),
        new GrammarRule<GreaterOrEqualThan>(false, [typeof(NameOrValue), typeof(PropertyAccess), typeof(Entity)]),
        new GrammarRule<GreaterThan>(false, [typeof(NameOrValue), typeof(PropertyAccess), typeof(Entity)], nextCharMatcher: c => c != EqualityTokenKeyword[0]),
